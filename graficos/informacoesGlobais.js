...
async function visualizarInformacoesGlobais(){
    ...
    paragrafo.innerHTML = `Você sabia que o mundo tem <span>${pessoasNoMundo} bilhões</span> de pessoas e que aproximadamente <span>${pessoasPraticandoEsportes} bilhões</span> estão praticando esportes em alguma ocupação e passam em média <span>${horas} horas</span> e <span>${minutos} minutos</span> Praticando esportes.<br>Porém, ainda existe aproximadamente <span>${porcentagemPraticandoEsportes}%</span> de pessoas praticando esportes .`
